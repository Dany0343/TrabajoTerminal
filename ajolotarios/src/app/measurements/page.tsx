                            ...
                            >
                              ...
                              <DialogContent>
                                ...
                                <div className="grid gap-4 py-4">
                                  ...
                                  <div className="grid grid-cols-4 items-center gap-4">
                                    <Label htmlFor="sensorTypeName" className="text-right">
                                      Nombre
                                    </Label>
                                    <Input
                                      id="sensorTypeName"
                                  ...
                                  <Button
                                    onClick={editingSensorTypeId ? updateSensorType : addSensorType}
                                  >
                                    {editingSensorTypeId ? 'Actualizar Tipo' : 'Agregar Tipo'}
                                  </Button>
                                </div>
                              </DialogContent>
                            </Dialog>
